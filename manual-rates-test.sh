...
###############################################################################
# MANUAL DAILY RATES TEST
# Testing the daily rates management flow manually before automation
###############################################################################
...
# Step 2: Navigate to Rates & Pricing
echo ""
echo "[3] Opening Rates & Pricing page..."
$AB open "$FRONTEND_URL/owner/rates"
$AB wait 4000

$AB screenshot "rates-page.png"

echo ""
echo "========================================="
echo " EXPLORE THE RATES PAGE"
echo "========================================="
echo ""
echo "Now explore the rates page to find:"
echo "  1. Room types list"
echo "  2. Base rate input fields"
echo "  3. Seasonal rates section"
echo "  4. Special dates section"
echo "  5. Save/Submit buttons"
echo ""
